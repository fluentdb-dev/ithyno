...
export function installClaudeNotifyHook(
  ...
  force?: boolean,
  opts?: { log?: (msg: string) => void; context?: "electron" | "vscode" | "cli" },
...
export function installCodexNotifyHook(projectRoot: string, scriptAbsPath: string, force?: boolean, opts?: { context?: "electron" | "vscode" | "cli" }): Promise<{ supported: true; settingsPath: string; changed: boolean }>;
...
export function installCopilotNotifyHook(projectRoot: string, scriptAbsPath: string, force?: boolean, opts?: { context?: "electron" | "vscode" | "cli" }): Promise<{ supported: true; settingsPath: string; changed: boolean }>;

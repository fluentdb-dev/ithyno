...
- [x] 2.2 Add `runInit` tests for create, skip, and `force` overwrite of
  `AGENTS.md`.
- [ ] 2.3 Add a new-project-chain regression test proving Codex initialization
...
- [ ] 4.1 Add tests that distinguish repository guidance from global Codex
...
- [ ] 5.3 Write `outcome.md` before archive, including the verified Codex

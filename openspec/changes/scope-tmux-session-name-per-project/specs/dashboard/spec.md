...
#### Scenario: agmsg block present with tmux installed → tmux wrap with per-project session name
...
#### Scenario: ITHYNO_TMUX_SESSION overrides the session name (literal, cross-project)

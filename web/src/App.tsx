      ...
      <main className="content">
        ...
        {!loading && state && !state.exists && (
          <div className="empty-state">
            ...
            {/* import-project-spec-generation: import button in empty-state */}
            {!importFlowActive && (
              <div className="empty-state-actions">
                <button
                  className="btn-secondary import-from-code-btn"
                  onClick={() => {
                    setImportFlowRoot(undefined);
                    setImportFlowActive(true);
                  }}
                >
                  Import: generate OpenSpec specs from existing code
                </button>
              </div>
            )}
            {importFlowActive && (
